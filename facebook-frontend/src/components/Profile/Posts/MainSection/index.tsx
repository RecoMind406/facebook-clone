...
export const PostsMain: React.FC<User> = (aUser) => {
            ...
            <Item>
                ...
                >
                    ...
                    >
                        ...
                        <PrimaryButton startIcon={<SettingsIcon />}>
                            Quản lý bài viết
                        </PrimaryButton>
                    </Box>
                    <Divider />
            ...
            {aUser.posts.map((post) => (
                <Item>
                    ...
                    >
                        ...
                        >
                            <Avatar src={aUser.profilePicture} />
                            <Box
                                sx={{
                                    display: "flex",
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Avatar
                                        alt={
                                            "Profile picture of original poster"
                                        }
                                        sx={{
                                            width: "32px",
                                            height: "32px",
                    ...
                    >
                        ...
                        >
                            <AvatarGroup>
                                ...
                                />
                                <Avatar
                                    alt="most 2nd reaction"
                                    src={loveIcon}
                                    // src={the most reaction 2}
                                    sx={{
                                        width: "18px",
                                        height: "18px",
                                    }}
                    ...
                    >
                        ...
                        <PrimaryButton
                            startIcon={<img src={shareIcon} width={"18px"} />}
                            sx={{
                                width: "100%",
                                backgroundColor: "transparent",
                                color: "#65676b",
...
const shareIcon = "https://cdn.onlinewebfonts.com/svg/img_335000.png";
const likeIcon =
