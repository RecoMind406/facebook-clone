...
import styles from "./PostItemOnGroup.module.scss";
		...
		<div className={cx("post-item")}>
			<div className={cx("heading")}>
				<div className={cx("information")}>
					<Link to={"/"} className={cx("image-infor")}>
					...
					<div className={cx("sub-info")}>
						...
						<div className={cx("publish")}>
							<span className={cx("name")}>{nameUser}</span>
			...
			<div className={cx("number-interact")}>
				<div className={cx("number-react")}>
					...
					<span className={cx("count")}>{numberReact}</span>
				</div>
				{/* Nếu count == 0 thì không hiện bình luận */}
				<div className={cx("commnet-share-count")}>
					{numberComment !== 0 && (
						<div className={cx("item")}>{numberComment} bình luận</div>
					)}
					{numberShare !== 0 && (
						<div className={cx("item")}>{numberShare} lượt chia sẻ</div>
					)}
				</div>
			</div>
					...
					<div className={cx("main-content-comment")}>
						<div>
							<div className={cx("comment-box")}>
								...
								<p className={cx("text-comment")}>{comment}</p>
							</div>
						</div>
						<div className={cx("button-comment-box")}>
							...
							<div className={cx("time-comment")}>2 giờ</div>
						</div>
					</div>
				</div>
			</div>
...
export default PostItemOnGroup;
