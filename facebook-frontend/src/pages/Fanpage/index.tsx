        ...
        <div className={cx('page')}>
            <div className={cx('header')}>
                <div className={cx('cover-image')} >
                    <img alt="" src="https://images.pexels.com/photos/616401/pexels-photo-616401.jpeg?cs=srgb&dl=pexels-lukas-616401.jpg&fm=jpg"  />
                </div>
                <div className={cx('interaction')}>
                    <div className={cx('avatar')}>
                        <img src="https://i.pinimg.com/280x280_RS/2e/c4/c5/2ec4c51f7930501e0721f8e5aecca45f.jpg" alt="" />
                    </div>
                    <div className={cx('name')}>
                        <h1> EC Food- Eat Clean Food</h1>
                        <span>18 lượt thích • 22 người theo dõi</span>
                        <div className={cx('follower')}>
                            <img src="https://img.freepik.com/premium-vector/healthy-food-eating-banner-with-woman-eating-fresh-salad-vegetables-flat-illustration-isolated-white-background-avatar-dieting-healthy-menu_181313-711.jpg?w=2000" alt="" />
                        </div>
                    </div>
                ...
                <div className={cx(`tab${activeTab}`)}>
                    <div className={cx('info')}>
                        ...
                        <div className={cx('image-collection')}>
                            ...
                            <img alt="" referrerPolicy="origin-when-cross-origin" src="https://tea-3.lozi.vn/v1/images/resized/hem-healthy-food-salad-and-eat-clean-quan-10-ho-chi-minh-1612301847016243160-eatery-avatar-1656985098?w=640&type=s"></img>
                            <img alt=""  referrerPolicy="origin-when-cross-origin" src="https://tea-3.lozi.vn/v1/images/resized/aceso-eat-clean-healthy-food-and-drink-shop-online-quan-hai-ba-trung-ha-noi-1611772519008042165-eatery-avatar-1611772519?w=640&type=s"></img>
                            <img alt=""  referrerPolicy="origin-when-cross-origin" src="https://i.pinimg.com/736x/68/e1/e8/68e1e8354921f70c073a06d068886429.jpg"></img>
                            <img alt=""  referrerPolicy="origin-when-cross-origin" src="https://i.pinimg.com/736x/68/e1/e8/68e1e8354921f70c073a06d068886429.jpg"></img>
                            <img alt=""  referrerPolicy="origin-when-cross-origin" src="https://tea-3.lozi.vn/v1/images/resized/aceso-eat-clean-healthy-food-and-drink-shop-online-quan-hai-ba-trung-ha-noi-1611772519008042165-eatery-avatar-1611772519?w=640&type=s"></img>
                            <img alt="" referrerPolicy="origin-when-cross-origin" src="https://tea-3.lozi.vn/v1/images/resized/hem-healthy-food-salad-and-eat-clean-quan-10-ho-chi-minh-1612301847016243160-eatery-avatar-1656985098?w=640&type=s"></img>
                            <img alt=""  referrerPolicy="origin-when-cross-origin" src="https://tea-3.lozi.vn/v1/images/resized/aceso-eat-clean-healthy-food-and-drink-shop-online-quan-hai-ba-trung-ha-noi-1611772519008042165-eatery-avatar-1611772519?w=640&type=s"></img>
                    ...
                    <div className={cx('content')}>
                       <div className={cx('remarkable')}>
                            ...
                            <div className={cx('post')}>
                                <div className={cx('name')}>
                                    <img height="100%" width="100%" src="https://i.pinimg.com/280x280_RS/2e/c4/c5/2ec4c51f7930501e0721f8e5aecca45f.jpg" style={{height: '40px', width: '40px'}}></img>
                                    <div>
                                ...
                                <img src="https://befresco.vn/fileuploads/Product/Content/Avatar/7f31737dfdd34d839b392b6b59cc7f0c.png" alt="" />
                            </div>
                       </div>
