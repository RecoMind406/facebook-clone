				...
				<div className={cx("sidebar")}>
					<div className={cx("header")}>
						...
						<div>
							<i
								style={{
									backgroundImage:
										'url("https://static.xx.fbcdn.net/rsrc.php/v3/y4/r/lqeqreVim_K.png")',
					...
					<div className={cx("body")}>
						...
						<div
							...
							role="separator"
							style={{ margin: "8px 16px" }}></div>
						<Tippy
							content="Truy cập bảng điều khiển"
							placement="right"
							interactive
							trigger="mouseenter"
							delay={1000}
						...
						<Tippy
							content="Truy cập Thông tin chi tiết"
							placement="right"
							interactive
							trigger="mouseenter"
							delay={1000}
						...
						<Tippy
							content="Quản lý quảng cáo và xem kết quả"
							placement="right"
							interactive
							trigger="mouseenter"
							delay={1000}
						...
						<Tippy
							content="Tạo quảng cáo để nhắm mục tiêu cao nhất có thể"
							placement="right"
							interactive
							trigger="mouseenter"
							delay={1000}
						...
						<Tippy
							content="Truy cập bảng Cài đặt trang"
							placement="right"
							interactive
							trigger="mouseenter"
							delay={1000}
						...
						<span className={cx("title")}>Công cụ khác</span>
						<Tippy
							content="Truy cập bảng Cài đặt trang"
							placement="right"
							interactive
					...
					<div className={cx("footer")}>
						<button>
							<i
								style={{
									backgroundImage:
										"url('https://static.xx.fbcdn.net/rsrc.php/v3/yr/r/vd0hki--2pD.png')",
					...
					<div className={cx("header")}>
						...
						<div className={cx("interaction")}>
							...
							<div className={cx("name")}>
								...
								<div className={cx("follower")}>
									<img
										src="https://img.freepik.com/premium-vector/healthy-food-eating-banner-with-woman-eating-fresh-salad-vegetables-flat-illustration-isolated-white-background-avatar-dieting-healthy-menu_181313-711.jpg?w=2000"
										alt=""
									/>
								</div>
							</div>
							<div className={cx("interact-btn")}>
								<button
									...
									<img
										src="https://static.xx.fbcdn.net/rsrc.php/v3/y-/r/9ZZIzT3-JPR.png"
										alt=""
										height="16"
										width="16"></img>{" "}
									{like && <>Đã thích</>} {!like && <>Thích trang</>}
								</button>
						...
						<div className={cx("tab-container")}>
							<div className={cx("tabs")}>
								...
								<div
									className={cx("tab", `${activeTab === 2 ? "active" : ""}`)}
									onClick={() => changeTab(2)}>
									Giới thiệu
								</div>
								<div
									className={cx("tab", `${activeTab === 3 ? "active" : ""}`)}
									onClick={() => changeTab(3)}>
									Lượt nhắc
								</div>
								<div
									className={cx("tab", `${activeTab === 4 ? "active" : ""}`)}
									onClick={() => changeTab(4)}>
									Đánh giá
								</div>
								<div
									className={cx("tab", `${activeTab === 5 ? "active" : ""}`)}
									onClick={() => changeTab(5)}>
									Người theo dõi
								</div>
								<div
									className={cx("tab", `${activeTab === 6 ? "active" : ""}`)}
									onClick={() => changeTab(6)}>
									Ảnh
								</div>
								<div
									...
									Xem thêm{" "}
									<svg fill="#999" viewBox="0 0 20 20" width="1em" height="1em">
							...
							<div
								...
								{option && (
									<div className={cx("tab7")}>
										<div>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/yv/r/WKkPKZz6y-9.png"
												alt=""
												height="20"
												width="20"></img>{" "}
											Tìm hỗ trợ hoặc báo cáo
										</div>
										<div>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/y1/r/4jlthrAbQvA.png"
												alt=""
												height="20"
												width="20"></img>{" "}
											Chặn
										...
										<div>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/y4/r/jNLv1VgfVNc.png"
												alt=""
												height="20"
												width="20"></img>{" "}
											Mời bạn bè
										...
										<div>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/yd/r/yxy6r9iNLiw.png"
												alt=""
												height="20"
												width="20"></img>
											Đang theo dõi
							...
							<div className={cx(`tab${activeTab}`)}>
								<div className={cx("info")}>
									<div className={cx("getting-started")}>
										<img
											src="https://www.facebook.com/images/profile_plus/Professional-Profiles-Transition-and-Onboarding/Page-Admin/WWW/Professional-Profiles-Page-Admin-WWW-2x.png"
											alt=""
										/>
										<span className={cx("bold")}>
											{" "}
											Xem lại các thay đổi với Trang
										</span>
										<span>
											EC Food- Eat Clean Food đã được cập nhật thành trải nghiệm
											Trang mới. Chúng tôi có thể giúp bạn xem lại những chi
											tiết thay đổi.
										</span>
									...
									<div className={cx("introduction")}>
										...
										<p>
											EC Food phục vụ cho những khách hàng không có thời gian để
											nấu ăn như sinh viên
										</p>
										<div>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/yj/r/XLGk7XTX1NS.png"
												alt=""
												height="20"
												width="20"></img>{" "}
											<span className={cx("bold")}>Trang </span> · Nhà hàng Thực
											phẩm Sức khỏe{" "}
										</div>
										<div>
											<img
												...
												height="20"
												width="20"></img>
											99 Trần Hưng Đạo, Quận 7, Ho Chi Minh City, Vietnam
										</div>
										<div>
											<img
												...
												height="20"
												width="20"></img>
											<a href="212is21101group09.myharavan.com">
												212is21101group09.myharavan.com
											</a>
										</div>
									</div>
									<div className={cx("image-collection")}>
										...
										<div className={cx("collection")}>
											<img
												alt=""
												referrerPolicy="origin-when-cross-origin"
												src="https://tea-3.lozi.vn/v1/images/resized/hem-healthy-food-salad-and-eat-clean-quan-10-ho-chi-minh-1612301847016243160-eatery-avatar-1656985098?w=640&type=s"></img>
											<img
												alt=""
												referrerPolicy="origin-when-cross-origin"
												src="https://tea-3.lozi.vn/v1/images/resized/aceso-eat-clean-healthy-food-and-drink-shop-online-quan-hai-ba-trung-ha-noi-1611772519008042165-eatery-avatar-1611772519?w=640&type=s"></img>
											<img
												alt=""
												referrerPolicy="origin-when-cross-origin"
												src="https://i.pinimg.com/736x/68/e1/e8/68e1e8354921f70c073a06d068886429.jpg"></img>
											<img
												alt=""
												referrerPolicy="origin-when-cross-origin"
												src="https://i.pinimg.com/736x/68/e1/e8/68e1e8354921f70c073a06d068886429.jpg"></img>
								...
								<div className={cx("content")}>
									<div className={cx("remarkable")}>
										...
										<div className={cx("post")}>
											...
											<span className={cx("description")}>
												#giveawaywithECFood #ECFood [GIVE AWAY] THAM GIA NGAY -
												NHẬN VOUCHER HẤP DẪN TẠI EC FOOD ...
											</span>
											<img
												src="https://befresco.vn/fileuploads/Product/Content/Avatar/7f31737dfdd34d839b392b6b59cc7f0c.png"
												alt=""
											/>
										</div>
									</div>
									...
									<div className={cx("status")}>
										...
										<div className={cx("status-react")}>
											<img
												...
												width="18"></img>{" "}
											Lâm, Ân, Ngọc và những người khác
										</div>
										<div className={cx("react-btn")}>
											<button>
												<i
													style={{
														backgroundImage:
															'url("https://static.xx.fbcdn.net/rsrc.php/v3/yA/r/yFwwUPU4oTd.png")',
									...
									<div className={cx("no-post")}>
										<img
											height="112"
											src="https://www.facebook.com/images/comet/empty_states_icons/files/null_states_files_gray_wash.svg"
											width="112"
											alt=""></img>
							...
							<div className={cx(`tab${activeTab}`)}>
								<div className={cx("introduction")}>
									...
									<div className={cx("right")}>
										...
										<p>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/xysEq_p-Grw.png"
												alt=""
												height="24"
												width="24"></img>{" "}
											Nhà hàng Thực phẩm Sức khỏe
										</p>
										...
										<p>
											<div>
												<div
													style={{
														backgroundImage:
															'url("https://external.fdad3-1.fna.fbcdn.net/static_map.php?v=2044&theme=default&ccb=4-4&size=544x250&language=vi_VN&scale=2&zoom=12&center=10.76759%2C106.69519&marker_list[0]=10.76759%2C106.69519&_nc_client_id=profile&_nc_client_caller=CometStaticMap.react")',
														backgroundRepeat: "no-repeat",
										...
										<p>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/yr/r/Tfkd21nE_8j.png"
												alt=""
												height="24"
												width="24"
											/>
											<a href="https://212is21101group09.myharavan.com/">
												https://212is21101group09.myharavan.com/
											</a>
										</p>
										<span className={cx("title")}>Thông tin cơ bản</span>
										<p>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/yi/r/OBE8J3Y1CJN.png"
												alt=""
												height="24"
												width="24"></img>
											Chưa xếp hạng (0 lượt đánh giá)
										</p>
										<p>
											<img
												src="https://static.xx.fbcdn.net/rsrc.php/v3/yf/r/EzO5YKuJljX.png"
												alt=""
												height="24"
												width="24"
											/>
							...
							<div className={cx(`tab${activeTab}`)}>
								<div className={cx("no-post")}>
									<img
										...
										alt=""></img>
									<div>
										Danh sách người theo dõi của EC Food- Eat Clean Food hiện
										không hiển thị.
									</div>
								</div>
							</div>
								...
								<div className={cx("image-collection")}>
									...
									<div className={cx("collection")}>
										<img
											alt=""
											referrerPolicy="origin-when-cross-origin"
											src="https://scontent.fdad3-5.fna.fbcdn.net/v/t39.30808-6/282408551_109646491751357_2871583357188856221_n.jpg?stp=c209.0.160.160a_dst-jpg_p160x160&amp;_nc_cat=102&amp;ccb=1-7&amp;_nc_sid=574b62&amp;_nc_ohc=OAqb_RuBMu8AX_CFoC_&amp;_nc_ht=scontent.fdad3-5.fna&amp;oh=00_AfCx9lpqobFi9mTJb_P8x2c76NCBMCSkA00UL2hd5RQVUw&amp;oe=6489D67F"></img>
										<img
											alt=""
											referrerPolicy="origin-when-cross-origin"
