...
function SuccessPopup() {
    ...
    return (
        ...
        <div className={cx("popup-content")}>
          <h2 className={cx("success-title")}>Thay đổi mật khẩu thành công!</h2>
          <p className={cx("success-description")}>Mật khẩu của bạn đã được cập nhật thành công. <br></br> Vui lòng kiểm tra mật khẩu trong hòm thư</p>
          <a href="#" className={cx("success-btn")} onClick={()=> navigate('/login')}>Đóng</a>
        </div>
      </div>
    );
  }
...
function ForgotPassword() {
    ...
    const handleSubmit= (e:any)=>{
        ...
        setShowPopup(true)
            ...
            setIsError(true);
            setError('Vui lòng kiểm tra định dạng email hoặc số điện thoại!')
  ...
  return (
    ...
    <div className={cx('fg-container')}>
        <form onSubmit={handleSubmit}>
            ...
            />
            {isError && <p className={cx('red')}>{error}</p>}
            </div>
